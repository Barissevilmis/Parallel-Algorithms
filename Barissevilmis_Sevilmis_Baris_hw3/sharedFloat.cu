...
__global__
void PermanentCalculator(long long int K, float* xCuda, float* pCuda, int* my_MCuda, unsigned long long int CHUNK, long long int N)
{
...
int main(int argc, const char** argv)
{
  ...
  *p = 1.0;
  ...
  cudaMemcpy(xCuda, x, sizeof(float)*N, cudaMemcpyHostToDevice);
