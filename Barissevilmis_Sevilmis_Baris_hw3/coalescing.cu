...
__global__
void PreProcess(double* xCuda, double* xx, long long int TOTAL, long long int xSIZE)
{
...
__global__
void PermanentCalculator(long long int K, double* xCuda, double* pCuda, int* my_MCuda, long long int CHUNK, long long int N, long long int xSIZE, long long int TOTAL)
{
